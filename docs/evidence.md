...
| LEASH sibling-read gate | `contracts/tests/leash-per-gate.ts` | Devnet TEE | `66cbab7` | 1 | Passed: agent read/consumed its own ledger; base and authenticated sibling direct/batch reads did not reveal the reservation | Live test output, 2026-09-08 | Demonstrated on devnet |
