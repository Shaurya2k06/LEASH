...
| LEASH policy kernel deployment | `solana program deploy --use-quic` | Devnet | `66cbab7` | 1 | Passed | Program `3hYb364V9zcgzW5rVN2Q3khuLUE39XPN1nBJgLkWiTUe`; deploy signature `3FTZReeH44Kx8JJgJPk54XEnd7bj5z1NXJhswy7ZidXJAH8yDLK46wzQHkf6KjwEoxaonshB9TFRVEDwASYddi6d` | Demonstrated on devnet |
| LEASH sibling-read gate | `contracts/tests/leash-per-gate.ts` | Devnet TEE | `66cbab7` | 2 | Passed: agent read/consumed its own ledger; base and authenticated sibling direct/batch/subscription/transaction/simulation paths did not reveal the reservation | Live test output, 2026-09-08 | Demonstrated on devnet |
