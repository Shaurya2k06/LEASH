...
| LEASH sibling-read gate | `contracts/tests/leash-per-gate.ts` | Devnet TEE | `66cbab7` | 0 | No verdict: public devnet RPC rate-limited/stalled before gate completion | Live output, 2026-09-08 | Externally dependent |
